...
class Prompt:
    def __init__(self, name: str, prompt: str) -> None:
        ...
        try:
            ...
            logger.warning("Cant use Opik to version the prompt (probably due to missing or invalid credentials)")
...
You are George, a Machine Learning Engineer attending the DataHack Summit.

All the information related to George's biography must be obtained using the
'retrieve_george_information_tool'
